/***********************************************
Repositorio Generico para todos los modelos

Creado: Carlos Cordoba
Fecha : 07-02-2017
***********************************************/
...
namespace Repository
{
    public class Repository<T> : IRepository<T> where T : class, new()
    {
        ...
        private CMS_CECBContext DbContext
        {
            get
            {
                var dbContext = _ambientDbContextLocator.Get<CMS_CECBContext>();
